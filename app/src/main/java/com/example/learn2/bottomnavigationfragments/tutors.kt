...
import com.example.learn2.Adapter.TutorAdapter
import com.example.learn2.Models.TutorViewModel
import com.example.learn2.R
import com.example.learn2.TutorDes
 ...
 * Use the [tutors.newInstance] factory method to
...
var items = ArrayList<TeacherData>()

class tutors : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = TutorAdapter(requireContext(), items,this)
        itemRecyclerView.adapter= adapter
        createDummyItemList()

        viewModel = ViewModelProvider(this).get(TutorViewModel::class.java)
    ...
    private fun createDummyItemList(){
        for (i in 1.. 100){
            items.add((TeacherData("Item"+i)))
        }
    }

    fun onItemItemClicked(position: Int){
        val intent = Intent(this@tutors.requireContext(),TutorDes::class.java)
